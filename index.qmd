...
-   Распознавание лиц на микрокомпьютерах[@site_1];
-   Секреты успешного собеседования: как получить оффер технарю[@site_2];
-   Как выжить на первом испытательном сроке в IT и не только[@site_3];
-   Как тимлиду проводить собеседование так, чтобы кандидат и компания получили от него максимум[@site_4];
-   Как создать решение в области контейнерной безопасности: подводные камни, проблемы и их решение[@site_5].
...
Теперь перейдите на вкладу [NLP-анализ](https://verona238.github.io/my-r-project/nlp.html), чтобы продолжить изучать мое исследование!
