...
Теперь делаю еще дополнительные преобзования. Во-первых, разделяю колонки с датами на отдельные колонки, добавляю колонку с количеством слов в тексте, и заменяю значения месяцев
...
И у меня получается общая таблица со всеми собранными данными.
