...
Давайте посмотрим на полученную таблицу. Для preview я взяла 10 последних строк. Мне нравится, как получилось! Полную таблицу как всегда предлагаю забрать по [ссылке](https://github.com/verona238/my-r-project/raw/refs/heads/main/data/articles_ppmi.RData).
